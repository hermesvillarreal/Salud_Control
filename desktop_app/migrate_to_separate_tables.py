"""
Migration script to separate health_records table into individual tables.
This script will:
1. Create new tables (weight_records, blood_pressure_records, glucose_records, food_records)
2. Migrate existing data from health_records to the new tables
3. Keep the original health_records table as backup
"""
...
def migrate_data():
    """Migrate data from health_records to separate tables."""
...
if __name__ == "__main__":
    ...
    print("="*50)
    print("This script will migrate data from health_records")
    print("to separate tables for weight, blood pressure,")
    print("glucose, and food records.")
    print("="*50)
